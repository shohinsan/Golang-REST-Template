...
const (
	TestApi_Echo_FullMethodName    = "/cmd.TestApi/Echo"
	TestApi_GetUser_FullMethodName = "/cmd.TestApi/GetUser"
)
...
// TestApiServer is the cmd API for TestApi service.
